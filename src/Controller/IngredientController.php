...
class IngredientController extends AbstractController
{
    ...
    {
        return $this->render('ingredient/listeAdmin.html.twig', [
    ...
    #[Route('/{idIng}', name: 'app_ingredient_show', methods: ['GET'])]
    ...
    #[Route('/{idIng}/edit', name: 'app_ingredient_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idIng}', name: 'app_ingredient_delete', methods: ['POST'])]
    public function delete(Request $request, Ingredient $ingredient, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$ingredient->getIdIng(), $request->request->get('_token'))) {
